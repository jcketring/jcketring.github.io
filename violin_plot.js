...
function violin_plot_input(plot_name, color, damage_type, initial, data) {
    var svg;
...
// update the elements
function update(nHours, initial) {
    ...
    d3.csv(source_file, function(data) {
        ...
        violin_plot_input("#chart6", "blue", "sewer", initial, filtered_data);
        violin_plot_input("#chart7", "yellow", "power", initial, filtered_data);
        violin_plot_input("#chart8", "green", "roads", initial, filtered_data);
        violin_plot_input("#chart9", "red", "medical", initial, filtered_data);
        violin_plot_input("#chart10", "violet", "buildings", initial, filtered_data);
    })
}
